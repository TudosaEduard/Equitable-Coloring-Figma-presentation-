...
Here is a first sketch of the main page:<br><br><br></p>
    ...
    <section id="qoc" role="doc-structure">
        ...
        <h2>5. Personas</h2>
        <p>About people who can interact with my application. It is quite difficult here to say exactly who those personas might be for my application, being a more particular one (only for certain categories of people). An example of a category of people who might be interested in my application would be the teachers to whom I will present my license, my algorithms being used to solve certain difficult scheduling problems, for example. Another type of personas could be high school students or students passionate about graph theory. But basically, for this presentation there are several anti-personas, unfortunately :))). Here are my parents, grandparents, neighbors, friends for fun:)), etc ...), as well as children who are too young to understand what is happening or students who are not passionate about these things / are not interested.</p>
    </section>
